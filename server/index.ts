...
(async () => {
  ...
  // Start the campaign email scheduler (best-effort; skip if module missing)
  try {
    const { startScheduler } = await import("./lib/campaign-scheduler");
    startScheduler(app);
  } catch (e) {
    console.error("Campaign scheduler failed to start:", e);
  }
